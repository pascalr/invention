...
int SerialPort::openPort(const char* device) {
...
void SerialPort::writePort(std::string str) {
  writePort(str.c_str());
}

void SerialPort::writePort(const char* str) {
...
int SerialPort::readBytes(char* buf, int length) {
