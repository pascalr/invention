...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/heda_index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/heda_index.js":
/*!********************************************!*\
  !*** ./app/javascript/packs/heda_index.js ***!
  \********************************************/
...
/* WEBPACK VAR INJECTION */(function($) {//function clearInputCommand() {
//  document.getElementById('inputcommand').value = '';
//}
$("#inputcommandform").bind('ajax:success', function (data, status, xhr) {
  document.getElementById('inputcommand').value = '';
}); //let form = document.getElementById('inputcommandform');
//form.addEventListener("submit", clearInputCommand, false);
// Really awful that I am not able to increment the text area in the partial...

document.addEventListener("logoutput-loaded", function (event) {
  var data = document.getElementById("logoutputdata");
...
/******/ });
//# sourceMappingURL=heda_index-a43291781fd61dee25b5.js.map