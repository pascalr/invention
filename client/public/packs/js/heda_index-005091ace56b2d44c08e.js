...
/* WEBPACK VAR INJECTION */(function($) {$("#inputcommandform").bind('ajax:success', function (data, status, xhr) {
  var inputCmd = document.getElementById('inputcommand');
  inputCmd.value = '';
  inputCmd.focus();
});
...
/******/ });
//# sourceMappingURL=heda_index-005091ace56b2d44c08e.js.map