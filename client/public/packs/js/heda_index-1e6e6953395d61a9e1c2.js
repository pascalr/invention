...
/* WEBPACK VAR INJECTION */(function($) {$("#inputcommand").bind("ajax:complete", function (event, xhr, status) {
  $('#inputcommand').val('');
});
document.getElementById('inputcommand').value = ''; // Really awful that I am not able to increment the text area in the partial...
...
/******/ });
//# sourceMappingURL=heda_index-1e6e6953395d61a9e1c2.js.map