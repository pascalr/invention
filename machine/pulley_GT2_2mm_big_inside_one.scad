...
teeth = 69;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
...
motor_shaft = 9.725;	// NEMA17 motor shaft exact diameter = 5, was 5.2, 3/8 is 9.525
...
//	translate ([0,0, pulley_b_ht + pulley_t_ht + retainer_ht ]) rotate ([0,180,0])
	...
	difference()
	 {	 
		...
		if ( (pulley_b_dia - motor_shaft)/2 < m3_nut_depth + 2 ) { echo ("CAN'T DRAW CAPTIVE NUTS, DIAMETER TOO SMALL FOR NUT DEPTH!!!"); } else {
